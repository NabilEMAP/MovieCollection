...
namespace MovieCollection.BLL.Services
{
    public class UsersService : IUsersService
    {
        ...
        public async Task<UserDetailDTO> Add(CreateUserDTO entity)
        {
        ...
        public async Task<IEnumerable<UserDetailDTO>> GetUserDetails()
        {
        ...
        public async Task<UserDetailDTO> Update(int id, UpdateUserDTO entity)
        {
            ...
            await _uow.Save();
            return _mapper.Map<UserDetailDTO>(userToUpdate);
        }
    }
}
