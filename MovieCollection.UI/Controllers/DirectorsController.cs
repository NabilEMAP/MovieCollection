...
namespace MovieCollection.UI.Controllers
{
    public class DirectorsController : Controller
    {
        ...
        public IActionResult Index(string SearchText = "", int pg = 1, int pageSize = 10)
        {
            ...
            HttpResponseMessage response = client.GetAsync(baseAddress + "/Directors/Details").Result;
            ...
            if (SearchText != "" && SearchText != null)
            {
                modelList = modelList.Where(p =>
                    ...
                    p.Nationality.Contains(SearchText) ||
            ...
            SPager SearchPager = new SPager(recsCount, pg, pageSize) { Action = "Index", Controller = "Directors", SearchText = SearchText };
